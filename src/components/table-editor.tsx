    ...
    <>
      ...
      <Dialog open={confirmRemove} onOpenChange={(open) => !open && setConfirmRemove(false)}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>{t.confirm.removeTableTitle}</DialogTitle>
            <DialogDescription>{t.confirm.removeTableDescription}</DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={() => setConfirmRemove(false)}>{t.actions.cancel}</Button>
            <Button variant="destructive" onClick={() => { onRemove(); setConfirmRemove(false); }}>{t.actions.delete}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
